...
class EnginesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engine" do
    assert_difference("Engine.count") do
      post engines_url, params: { engine: { cylinders: @engine.cylinders, vehicle_id: @engine.vehicle_id } }
    end
  ...
  test "should update engine" do
    patch engine_url(@engine), params: { engine: { cylinders: @engine.cylinders, vehicle_id: @engine.vehicle_id } }
